package com.marcarndt.morse.telegrambots.logging;
 ...
 * @version 1.0
 *
 *          Handler to use a file as logs destination with {@link BotLogger}
 */
public class BotsFileHandler extends FileHandler {
  ...
  public BotsFileHandler(String pattern, int limit, int count)
      throws IOException, SecurityException {
    super(pattern, limit, count);
    setFormatter(new FileFormatter());
  }

  public BotsFileHandler(String pattern, int limit, int count, boolean append)
      throws IOException, SecurityException {
