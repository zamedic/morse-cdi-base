 ...
 *          Telegram clients to display them in the music player. Your audio must be in an .mp3
 *          format. On success, the sent Message is returned. Bots can currently send audio files of
