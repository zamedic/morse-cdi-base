package com.marcarndt.morse.telegrambots.api.objects.replykeyboard.buttons;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.marcarndt.morse.telegrambots.api.interfaces.InputBotApiObject;
import com.marcarndt.morse.telegrambots.api.interfaces.Validable;
import com.marcarndt.morse.telegrambots.api.objects.games.CallbackGame;
...
public class InlineKeyboardButton implements InputBotApiObject, Validable {
   ...
   *
   * This offers an easy way for users to start using your bot in inline mode when they are
   * currently in a private chat with it. Especially useful when combined with switch_pm… actions –
   * in this case the user will be automatically returned to the chat they switched from, skipping
