 ...
 *
 *          request_contact and request_location options will only work in Telegram versions
...
public class KeyboardButton implements InputBotApiObject, Validable {
  ...
  /**
   * Text of the button. If none of the optional fields are used, it will be sent to the bot as a
  ...
  public void validate() throws TelegramApiValidationException {
    ...
    if (requestContact != null && requestLocation != null && requestContact && requestLocation) {
      throw new TelegramApiValidationException("Cant request contact and location at the same time",
          this);
    }
  }
