 ...
 *          bot, the field message will be present. If the button was attached to a message sent via
...
public class CallbackQuery implements BotApiObject {
   ...
   *
   * The message content and message date will not be available if the message is too old
   */
