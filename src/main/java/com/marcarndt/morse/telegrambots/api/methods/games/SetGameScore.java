...
package com.marcarndt.morse.telegrambots.api.methods.games;
 ...
 * @version 2.4 Use this method to set the score of the specified user in a game. On success, if the
 *          message was sent by the bot, returns the edited Message, otherwise returns True.
 *
