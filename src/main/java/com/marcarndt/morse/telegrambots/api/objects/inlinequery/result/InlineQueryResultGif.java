 ...
 * @version 1.0
 *
 *          Represents a link to an animated GIF file. By default, this animated GIF file will be
 *          sent by the user with optional caption. Alternatively, you can use input_message_content
