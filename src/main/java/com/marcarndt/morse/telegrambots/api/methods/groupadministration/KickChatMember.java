 ...
 * @version 1.0 the user will not be able to return to the group on their own using invite links,
 *          etc., unless unbanned first. The bot must be an administrator in the group for this to
