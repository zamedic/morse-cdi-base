package com.marcarndt.morse.telegrambots.api.methods.send;

import com.fasterxml.jackson.core.type.TypeReference;
import com.marcarndt.morse.telegrambots.api.methods.PartialBotApiMethod;
import com.marcarndt.morse.telegrambots.api.objects.Message;
import com.marcarndt.morse.telegrambots.api.objects.replykeyboard.ApiResponse;
import com.marcarndt.morse.telegrambots.api.objects.replykeyboard.ReplyKeyboard;
 ...
 * @version 1.0 Use this method to send general files. On success, the sent Message is returned.
 */
public class SendDocument extends PartialBotApiMethod<Message> {
   ...
   *
   * @param document File_id of the document to send The file_id must have already been received or
   * sent by your bot
   * @return Senddocument
   */
